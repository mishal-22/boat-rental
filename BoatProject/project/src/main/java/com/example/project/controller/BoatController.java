...
public class BoatController {
	...
	@PostMapping()
	public String addBoat(@RequestParam("photo") MultipartFile file, @RequestParam("boatName") String boatName,
		...
		return boatService.addboat(username, boatName, capacity, price, description, file, isActive);
	}
	...
	public List<Boat> getAllBoatsForUsers() {
		return boatService.getAllBoatsForUsers();
	}
